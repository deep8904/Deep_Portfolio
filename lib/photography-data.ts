export type Photo = {
  ...
  height: number;
  featured: boolean;
  /** "portfolio" = shown on /visuals by default. "archive" = only in the full archive view. */
  visibility: "portfolio" | "archive";
  sortOrder: number;
 ...
 * (published only after the owner explicitly confirmed it — see
 * docs/photography-manifest.md). 'visibility' distinguishes the curated
 * portfolio (~34 strongest images, shown by default on /visuals) from the
 * full archive (all 120, revealed on request). Portfolio entries are
 * sequenced first and by hand for editorial rhythm (orientation, color,
 * subject); archive entries follow in a category-rotated order.
 */
const RAW_PHOTOS: Omit<Photo, "sortOrder">[] = [
  {
    ...
    width: 1350, height: 2400, featured: true, visibility: "portfolio",
    originalFilename: "IMG_7158.jpg",
  },
  {
    ...
    width: 1800, height: 2400, featured: true, visibility: "portfolio",
    originalFilename: "IMG_7029.jpg",
  },
  {
    ...
    width: 2400, height: 2400, featured: true, visibility: "portfolio",
    originalFilename: "IMG_5876.jpg",
  },
  {
    ...
    width: 1350, height: 2400, featured: false, visibility: "portfolio",
    originalFilename: "IMG_4028.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1800, featured: true, visibility: "portfolio",
    originalFilename: "IMG_1337.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1920, height: 2400, featured: false, visibility: "portfolio",
    originalFilename: "IMG_0675.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1800, featured: false, visibility: "portfolio",
    originalFilename: "IMG_0535.jpg",
  },
  {
    ...
    width: 2400, height: 1714, featured: false, visibility: "portfolio",
    originalFilename: "IMG_7466.jpg",
  },
  {
    ...
    width: 1800, height: 2400, featured: false, visibility: "portfolio",
    originalFilename: "IMG_5418.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1350, height: 2400, featured: false, visibility: "portfolio",
    originalFilename: "IMG_0705_jpg.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1600, height: 2400, featured: false, visibility: "portfolio",
    originalFilename: "IMG_5976.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1600, featured: false, visibility: "portfolio",
    originalFilename: "DSC05551.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1350, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_5428.jpg",
  },
  {
    ...
    width: 1712, height: 1284, featured: false, visibility: "archive",
    originalFilename: "APC_0137.jpg",
  },
  {
    ...
    width: 2400, height: 1800, featured: false, visibility: "archive",
    originalFilename: "IMG_2343.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1350, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_0665_jpg.jpg",
  },
  {
    ...
    width: 1920, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_7227.jpg",
  },
  {
    ...
    width: 1800, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_6931.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1350, featured: false, visibility: "archive",
    originalFilename: "APC_0035.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1440, featured: false, visibility: "archive",
    originalFilename: "IMG_8186.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1350, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_0763_jpg.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1714, featured: false, visibility: "archive",
    originalFilename: "IMG_3573.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1714, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_5885.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1711, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_5501.jpg",
  },
  {
    ...
    width: 1232, height: 2190, featured: false, visibility: "archive",
    originalFilename: "IMG_3156.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_5539.jpg",
  },
  {
    ...
    width: 1440, height: 2268, featured: false, visibility: "archive",
    originalFilename: "IMG_5554.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 853, featured: false, visibility: "archive",
    originalFilename: "IMG_6565.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 2400, height: 1715, featured: false, visibility: "archive",
    originalFilename: "IMG_7035.jpg",
  },
  {
  ...
  },
  {
    ...
    width: 1800, height: 2400, featured: false, visibility: "archive",
    originalFilename: "IMG_3678.jpg",
  },];

export const PHOTOS: Photo[] = RAW_PHOTOS.map((p, i) => ({ ...p, sortOrder: i }));

export const PORTFOLIO_PHOTOS: Photo[] = PHOTOS.filter((p) => p.visibility === "portfolio");

const CATEGORY_ORDER = ["Architecture", "Places", "Nature", "Details", "Automotive", "Street", "Events", "Food"];

/** Filters shown on the default (curated) view — only categories with a portfolio-tier photo. */
export const PHOTO_CATEGORIES = CATEGORY_ORDER.filter((cat) => PORTFOLIO_PHOTOS.some((p) => p.category === cat));

/** Filters shown once the visitor opens the full archive — categories across the whole library. */
export const ARCHIVE_CATEGORIES = CATEGORY_ORDER.filter((cat) => PHOTOS.some((p) => p.category === cat));
