...
export function CaseStudySection({
  ...
  return (
    // scroll-mt accounts for MobileNav's sticky bar (below tab:) and
    // ChapterNav's sticky bar (tab: and up) so an anchor jump doesn't land
    // a section's heading underneath either one.
    <Section tight={tight} id={id} className={id ? "scroll-mt-[60px] tab:scroll-mt-[54px]" : undefined}>
      <Reveal as="article">
