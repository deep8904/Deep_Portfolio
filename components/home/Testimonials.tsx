      ...
      <Reveal>
        <div className="flex flex-wrap items-end justify-between gap-5">
          <div className="flex flex-col items-start gap-4">
            ...
            <h2 className="m-0 max-w-full text-h2 font-medium tracking-[-0.028em] text-balance tab:max-w-[30ch] desk:max-w-[46ch]">
        ...
        >
          {TESTIMONIALS.map((q) => (
            ...
            >
              <blockquote className="m-0 mb-auto text-p2 text-ink-secondary text-pretty">
                {q.text}
              </blockquote>
